...
{
    /// <inheritdoc />
    public partial class _001_InitialFixedDbSets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketCommments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketCommments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TicketCommments_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCommments_TicketId",
                table: "TicketCommments",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketCommments_UserId",
                table: "TicketCommments",
                column: "UserId");
