    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                Company compnay = new()
                {
                    Name = Input.CompnayName,
                    Description = Input.CompnayName
                };

                await _context.AddAsync(compnay);
                await _context.SaveChangesAsync();

                //Creat New User (and make them a member of the company uaing the foreign key relationship)
                var user = CreateUser();
